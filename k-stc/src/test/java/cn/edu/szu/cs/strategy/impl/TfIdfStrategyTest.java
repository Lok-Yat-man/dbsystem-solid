...
class TfIdfStrategyTest {
    ...
    void testCalculate() {
        ...
        List<DbScanRelevantObject> relatedObjects = List.of(
                new DbScanRelevantObject("1", new double[] { 1, 1 }, "a",
                        List.of("The", "sky", "is", "blue", "and", "beautiful")),
                new DbScanRelevantObject("2", new double[] { 1, 1 }, "b",
                        List.of("The", "sun", "is", "bright", "and", "the", "sky", "is", "blue")),
                new DbScanRelevantObject("3", new double[] { 1, 1 }, "c",
                        List.of("The", "sun", "in", "the", "sky", "is", "bright")));

        tfIdfStrategy.calculate(relatedObjects);

        // Assert.equals(relatedObjects.get(0).getWeight("and"), 0.21233625702021347);
        // Assert.equals(relatedObjects.get(0).getWeight("beautiful"),
        // 0.5753274859595731);
