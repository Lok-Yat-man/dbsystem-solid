...
public class DCPGSManager {
    ...
    public void dcpgsRun(String checkInFilePath, String key, String dataSet) throws Exception {
        ...
        //输出结果到文件
        CheckInReader.outPutCheckIn(clusters, filePath);
        CheckInReader.parseGeoJsonTo(filePath, String.format("%s/geojson/%s_%.1f_%.1f_%.1f_%.1f.geojson",
                dataSet,key,params.getEpsilon(),params.getOmega(),params.getTau(),params.getMaxD()));
    ...
    public DCPGSParams getParams(String key){
        return paramsMap.getOrDefault(key, null);
    }
    ...
    public void setAllParams(String key, DCPGSParams dcpgsParams){
